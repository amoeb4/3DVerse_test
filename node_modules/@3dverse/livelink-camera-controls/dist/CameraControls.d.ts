...
import { Components, Quat, Vec3 } from '@3dverse/livelink.core';
import { Ref, MOUSE_BUTTON, ACTION, DOLLY_DIRECTION, PointerInput, MouseButtons, Touches, CameraControlsEventMap, FitToOptions } from './types';
import { EventDispatcher } from './EventDispatcher';
import { OrthographicCamera, PerspectiveCamera } from 'utils/Camera';
export interface ViewportInterface {
    readonly aspect_ratio: number;
    readonly dom_element: HTMLElement;
    readonly overlay_dom_elements: Array<HTMLElement>;
}
export declare class CameraControls extends EventDispatcher {
    ...
    */
    ...
    protected _targetVelocity: THREE.Vector3;
    protected _focalOffsetVelocity: THREE.Vector3;
    protected _zoomVelocity: Ref;
    protected _livelink_viewport: ViewportInterface;
    /**
     ...
     */
    constructor(localTransform: Components.LocalTransform, lens: Components.PerspectiveLens | Components.OrthographicLens, viewport: ViewportInterface);
    /*
    ...
    */
     ...
     * @category Methods
     */
    fitToBox(aabb: THREE.Box3, enableTransition: boolean, { cover, paddingLeft, paddingRight, paddingBottom, paddingTop }?: Partial<FitToOptions>): Promise<void[]>;
    /**
     ...
     * @category Methods
     */
    fitToSphere(boundingSphere: THREE.Sphere, enableTransition: boolean): Promise<void[]>;
    /**
     ...
     */
    dispose(): void;
    protected _getTargetDirection(out: THREE.Vector3): THREE.Vector3;
    protected _getCameraDirection(out: THREE.Vector3): THREE.Vector3;
