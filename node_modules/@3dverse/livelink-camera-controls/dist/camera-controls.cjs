...
var THREE = require('threejs-math');
...
let _m1 = new THREE__namespace.Matrix4();
let _position = new THREE__namespace.Vector3();
/**
 *
 */
class Camera {
     ...
     */
    matrix = new THREE__namespace.Matrix4();
    /**
     * Global transform matrix
     */
    matrixWorld = new THREE__namespace.Matrix4();
    /**
     * This is the inverse of matrixWorld. MatrixWorld contains the Matrix which has the world transform of the Camera.
     */
    matrixWorldInverse = new THREE__namespace.Matrix4();
    /**
     * This is the matrix which contains the projection.
     */
    projectionMatrix = new THREE__namespace.Matrix4();
    /**
     * The inverse of projectionMatrix.
     */
    projectionMatrixInverse = new THREE__namespace.Matrix4();
    /**
    ...
    constructor(localTransform) {
        this.position = new THREE__namespace.Vector3().fromArray(localTransform.position);
        this.quaternion = new THREE__namespace.Quaternion().fromArray(localTransform.orientation);
        this.up = new THREE__namespace.Vector3(0, 1, 0);
    }
    /**
     *
     */
...
const VERSION = '0.4.9'; // will be replaced with `version` in package.json during the build process.
const TOUCH_DOLLY_FACTOR = 1 / 8;
const isMac = /Mac/.test(globalThis?.navigator?.platform);
const _AXIS_Y = Object.freeze(new THREE__namespace.Vector3(0, 1, 0));
const _AXIS_Z = Object.freeze(new THREE__namespace.Vector3(0, 0, 1));
...
const _cameraDirection = new THREE__namespace.Vector3();
const _xColumn = new THREE__namespace.Vector3();
const _yColumn = new THREE__namespace.Vector3();
const _zColumn = new THREE__namespace.Vector3();
const _deltaTarget = new THREE__namespace.Vector3();
const _deltaOffset = new THREE__namespace.Vector3();
const _sphericalA = new THREE__namespace.Spherical();
const _sphericalB = new THREE__namespace.Spherical();
const _box3B = new THREE__namespace.Box3();
const _quaternionA = new THREE__namespace.Quaternion();
const _quaternionB = new THREE__namespace.Quaternion();
class CameraControls extends EventDispatcher$1 {
    ...
    _targetVelocity = new THREE__namespace.Vector3();
    _focalOffsetVelocity = new THREE__namespace.Vector3();
     ...
     */
    constructor(localTransform, lens, aspectRatio, domElement) {
        super();
        const isPerspective = 'fovy' in lens;
        this._aspectRatio = aspectRatio;
        this._camera = isPerspective ? new PerspectiveCamera(localTransform, lens, aspectRatio) : new OrthographicCamera(localTransform, lens, aspectRatio);
        this._yAxisUpSpace = new THREE__namespace.Quaternion().setFromUnitVectors(this._camera.up, _AXIS_Y);
        this._yAxisUpSpaceInverse = this._yAxisUpSpace.clone().invert();
        this._state = ACTION.NONE;
        // the location
        this._target = new THREE__namespace.Vector3();
        this._targetEnd = this._target.clone();
        this._focalOffset = new THREE__namespace.Vector3();
        this._focalOffsetEnd = this._focalOffset.clone();
        // rotation
        this._spherical = new THREE__namespace.Spherical().setFromVector3(_v3A.copy(this._camera.position).applyQuaternion(this._yAxisUpSpace));
        ...
        this._boundary = new THREE__namespace.Box3(new THREE__namespace.Vector3(-Infinity, -Infinity, -Infinity), new THREE__namespace.Vector3(Infinity, Infinity, Infinity));
        // reset
        ...
        this._dollyControlCoord = new THREE__namespace.Vector2();
        // configs
        this.mouseButtons = {
            left: ACTION.ROTATE,
            middle: ACTION.DOLLY,
        ...
        const dragStartPosition = new THREE__namespace.Vector2();
        const lastDragPosition = new THREE__namespace.Vector2();
        const dollyStart = new THREE__namespace.Vector2();
        const onPointerDown = (event) => {
            if (!this._enabled || !this._domElement)
                return;
            if (event.target !== this._domElement)
                return;
     ...
     */
    get direction() {
        return this._getCameraDirection(new THREE__namespace.Vector3()).normalize();
    }
    /**
    ...
    setViewport(viewportOrX, y, width, height) {
        ...
        this._viewport = this._viewport || new THREE__namespace.Vector4();
    ...
    getTarget(out, receiveEndValue = true) {
        const _out = !!out && out.isVector3 ? out : new THREE__namespace.Vector3();
    ...
    getSpherical(out, receiveEndValue = true) {
        const _out = out || new THREE__namespace.Spherical();
...
class KeyboardFlyControls {
    ...
    _moveFront = (event) => {
        ...
        move.add(this._cameraControls.getPosition(new THREE.Vector3()));
...
if (typeof window !== "undefined") {
    ...
    if (Object.prototype.hasOwnProperty.call(window.__LIVELINK__, "@3dverse/livelink-camera-controls")) {
        ...
        window.__LIVELINK__["@3dverse/livelink-camera-controls"] = "0.4.9";
    }
}

exports.ACTION = ACTION;
exports.Clock = Clock;
exports.DOLLY_DIRECTION = DOLLY_DIRECTION;
exports.EventDispatcher = EventDispatcher$1;
exports.KeyboardFlyControls = KeyboardFlyControls;
