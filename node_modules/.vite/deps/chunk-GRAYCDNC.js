...
var qh = function(i8, t) {
  ...
  if (h) typeof read < "u" && (e.read = function(b) {
    ...
    var U2;
    return typeof readbuffer == "function" ? new Uint8Array(readbuffer(b)) : (U2 = read(b, "binary"), y(typeof U2 == "object"), U2);
    ...
    return U2.open("GET", b, false), U2.send(null), U2.responseText;
  }, o && (e.readBinary = function(b) {
    var U2 = new XMLHttpRequest();
    return U2.open("GET", b, false), U2.responseType = "arraybuffer", U2.send(null), new Uint8Array(U2.response);
  }), e.readAsync = function(b, U2, I2) {
    var H2 = new XMLHttpRequest();
    H2.open("GET", b, true), H2.responseType = "arraybuffer", H2.onload = function() {
  ...
  function l(T) {
    y(!Zi);
    var b = $2;
    return $2 = $2 + T + 15 & -16, b;
  }
  function d(T, b) {
    b || (b = c);
    var U2 = T = Math.ceil(T / b) * b;
    return U2;
  }
  ...
  function y(T, b) {
    T || Pt2("Assertion failed: " + b);
  }
  function M(T, b) {
    if (b === 0 || !T) return "";
    for (var U2 = 0, I2, H2 = 0; I2 = O2[T + H2 >> 0], U2 |= I2, !(I2 == 0 && !b || (H2++, b && H2 == b)); ) ;
    b || (b = H2);
    var nt2 = "";
    if (U2 < 128) {
      for (var st2 = 1024, ot2; b > 0; ) ot2 = String.fromCharCode.apply(String, O2.subarray(T, T + Math.min(b, st2))), nt2 = nt2 ? nt2 + ot2 : ot2, T += st2, b -= st2;
      return nt2;
    }
    return E(T);
  }
  ...
  function x(T, b) {
    for (var U2 = b; T[U2]; ) ++U2;
    if (U2 - b > 16 && T.subarray && v) return v.decode(T.subarray(b, U2));
    for (var I2, H2, nt2, st2, ot2, gt2, xt2 = ""; ; ) {
      if (I2 = T[b++], !I2) return xt2;
      if (!(I2 & 128)) {
        xt2 += String.fromCharCode(I2);
        continue;
      }
      if (H2 = T[b++] & 63, (I2 & 224) == 192) {
        xt2 += String.fromCharCode((I2 & 31) << 6 | H2);
        continue;
      }
      if (nt2 = T[b++] & 63, (I2 & 240) == 224 ? I2 = (I2 & 15) << 12 | H2 << 6 | nt2 : (st2 = T[b++] & 63, (I2 & 248) == 240 ? I2 = (I2 & 7) << 18 | H2 << 12 | nt2 << 6 | st2 : (ot2 = T[b++] & 63, (I2 & 252) == 248 ? I2 = (I2 & 3) << 24 | H2 << 18 | nt2 << 12 | st2 << 6 | ot2 : (gt2 = T[b++] & 63, I2 = (I2 & 1) << 30 | H2 << 24 | nt2 << 18 | st2 << 12 | ot2 << 6 | gt2))), I2 < 65536) xt2 += String.fromCharCode(I2);
      else {
        var Et2 = I2 - 65536;
  ...
  function Te2(T) {
    for (; T.length > 0; ) {
      ...
      var U2 = b.func;
      typeof U2 == "number" ? b.arg === void 0 ? e.dynCall_v(U2) : e.dynCall_vi(U2, b.arg) : U2(b.arg === void 0 ? null : b.arg);
    }
  }
  ...
  function Ts() {
    ...
    typeof e.locateFile == "function" && (Xe2(T) || (T = e.locateFile(T)), Xe2(Kt) || (Kt = e.locateFile(Kt)), Xe2(b) || (b = e.locateFile(b)));
  ...
  var tt2 = { varargs: 0, get: function(T) {
    tt2.varargs += 4;
    var b = z2[tt2.varargs - 4 >> 2];
    return b;
  }, getStr: function() {
    var T = M(tt2.get());
    return T;
  }, get64: function() {
    var T = tt2.get(), b = tt2.get();
  ...
  function Ps(T, b, U2) {
    return O2.set(O2.subarray(b, b + U2), T), T;
  }
  function Os(T) {
  ...
  e.run = en;
  function zs(T, b) {
    b && e.noExitRuntime && T === 0 || (e.noExitRuntime || (f = true, _ = T, qe2 = Ds, gs(), e.onExit && e.onExit(T)), a && process.exit(T), e.quit(T, new We2(T)));
  }
  e.exit = zs;
  function Pt2(T) {
...
function nn({ sceneId: e, sessionId: t, isTransient: n, token: r, LoadingPanel: o, InactivityWarningPanel: i8, ConnectionErrorPanel: s, autoJoinExisting: a = true, clientType: l, children: p }) {
  let [c, d] = (0, import_react2.useState)(null), [m, g2] = (0, import_react2.useState)(true), [u, C] = (0, import_react2.useState)(false), [x, w] = (0, import_react2.useState)(null), [j2, T] = (0, import_react2.useState)("Unknown error"), f = (0, import_react2.useRef)(/* @__PURE__ */ new Map()), b = (0, import_react2.useCallback)(() => c == null ? void 0 : c.disconnect(), [c]);
  return (0, import_react2.useEffect)(() => {
    ...
    return v({ autoJoinExisting: a, sceneId: e, sessionId: t, token: r, clientType: l }).then((y) => {
      ...
      E.abort(), c == null ? void 0 : c.session.removeEventListener("on-inactivity-warning", w), c == null ? void 0 : c.session.removeEventListener("on-activity-detected", h), d(null), g2(true), C(false), w(null);
    };
    ...
    return c.session.addEventListener("on-disconnected", L2), () => {
      c.session.removeEventListener("on-disconnected", L2);
    };
  }, [c]), (0, import_react2.useEffect)(() => () => {
    c == null ? void 0 : c.disconnect();
  }, [c]), import_react2.default.createElement(P.Provider, { value: { instance: c, isConnecting: m, isDisconnected: u, disconnect: b } }, m && o && import_react2.default.createElement(o, { stage: "" }), u && s && import_react2.default.createElement(s, { error: j2 }), x && i8 && import_react2.default.createElement(i8, { warningDuration: x.seconds_remaining, onActivityDetected: () => {
    x.resetTimer(), w(null);
  } }), p);
}
function Le2(e) {
...
function ee(e, t = []) {
  let { instance: n } = (0, import_react.useContext)(P), [r, o] = (0, import_react.useState)(null), [i8, s] = (0, import_react.useState)(true), [, a] = (0, import_react.useReducer)((p) => p + 1, 0), l = e;
...
function un2(e = {}, t = []) {
  let { name: n = "Camera", position: r = [0, 1, 5], orientation: o = [0, 0, 0, 1], eulerOrientation: i8 = [0, 0, 0], renderGraphRef: s = "398ee642-030a-45e7-95df-7147f6c43392", settings: a = { grid: true, skybox: false, gradient: true }, renderTargetIndex: l = -1, perspective_lens: p = { fovy: 60, nearPlane: 0.1, farPlane: 1e4 } } = e, c = "orientation" in e ? o : void 0, d = !c && "eulerOrientation" in e ? i8 : void 0, m = "orthographic_lens" in e ? e.orthographic_lens : void 0, g2 = m ? void 0 : p, { isPending: u, entity: C } = ee({ name: n, components: { local_transform: { position: r, orientation: c, eulerOrientation: d }, camera: { renderGraphRef: s, dataJSON: a, renderTargetIndex: l }, perspective_lens: g2, orthographic_lens: m }, options: { auto_broadcast: false, delete_on_client_disconnection: true } }, t);
  return { isPending: u, cameraEntity: C };
}
var k2 = (0, import_react4.createContext)({ canvas: null, renderingSurface: null });
function gn2({ children: e, contextType: t = "2d", contextAttributes: n, width: r, height: o, ...i8 }) {
  let { instance: s } = (0, import_react4.useContext)(P), { canvas: a } = (0, import_react4.useContext)(k2), [l, p] = (0, import_react4.useState)(null), c = (0, import_react4.useRef)(null);
  ...
  }, [s, t, n]), import_react4.default.createElement(k2.Provider, { value: { canvas: c.current, renderingSurface: l } }, import_react4.default.createElement("div", { "data-role": "canvas-container", style: Te({ parentCanvas: a, width: r, height: o }), ...i8 }, import_react4.default.createElement("canvas", { ref: c, style: { position: "absolute", width: "100%", height: "100%", pointerEvents: "none" } }), e));
}
...
var Dn2 = (0, import_react5.forwardRef)(function({ setHoveredEntity: e, setPickedEntity: t, renderTargetIndex: n = -1, children: r, ...o }, i8) {
  let { cameraEntity: s, client: a, cameraIndex: l, ...p } = o, { instance: c } = (0, import_react5.useContext)(P), { renderingSurface: d, canvas: m } = (0, import_react5.useContext)(k2), { zIndex: g2 = 0 } = (0, import_react5.useContext)(O), [u, C] = (0, import_react5.useState)(null), [x, w] = (0, import_react5.useState)(null), [j2, T] = (0, import_react5.useState)(null), f = (0, import_react5.useRef)(null);
  ...
  return (0, import_react5.useEffect)(() => {
    if (!(!c || !d || !m || !f.current)) try {
      let v = dt.from_dom_elements({ element: f.current, parent: m }), E = new Ir({ core: c, rendering_surface: d, options: { rect: v, z_index: L2, render_target_index: n, dom_element: f.current } });
  ...
  }, [c, d, m, L2]), (0, import_react5.useEffect)(() => {
...
var Un2 = (0, import_react6.forwardRef)(function({ preset: t = Pn.orbital, children: n }, r) {
  let { viewport: o, camera: i8 } = (0, import_react6.useContext)(O), [s, a] = (0, import_react6.useState)(void 0);
...
function Jn2({ fileOptions: e = { description: "Video recording", accept: { "video/webm": [".webm"] } }, recorderOptions: t = { mimeType: 'video/webm; codecs="vp8"', videoBitsPerSecond: 1e7 }, streamOptions: n = { frameRequestRate: 30 }, children: r }) {
  let { renderingSurface: o } = (0, import_react7.useContext)(k2), [i8, s] = (0, import_react7.useState)(0), [a, l] = (0, import_react7.useState)(false), p = (0, import_react7.useMemo)(() => {
    if (!o) return null;
  ...
  }, [a]), import_react7.default.createElement(import_react7.default.Fragment, null, r ? r({ recordTime: i8 }) : null);
}
var U = 1e-6;
...
var F = {};
Ce2(F, { add: () => it2, angle: () => Rt2, bezier: () => Et, ceil: () => st, clone: () => tt, copy: () => rt, create: () => se2, cross: () => ht, dist: () => Vt2, distance: () => de2, div: () => It2, divide: () => pe2, dot: () => ve2, equals: () => Dt2, exactEquals: () => kt2, floor: () => at2, forEach: () => Ut2, fromValues: () => nt, hermite: () => xt, inverse: () => vt2, len: () => zt, length: () => ae2, lerp: () => yt2, max: () => lt2, min: () => ct2, mul: () => At2, multiply: () => le, negate: () => ut2, normalize: () => ft, random: () => Ct2, rotateX: () => Lt2, rotateY: () => Pt, rotateZ: () => Mt2, round: () => pt2, scale: () => dt2, scaleAndAdd: () => mt2, set: () => ot, sqrDist: () => Tt2, sqrLen: () => Nt2, squaredDistance: () => me2, squaredLength: () => ue2, str: () => bt2, sub: () => Ot, subtract: () => ce, transformMat3: () => gt, transformMat4: () => _t28, transformQuat: () => wt2, zero: () => St2 });
function se2() {
  var e = new V(3);
...
function ht(e, t, n) {
  var r = t[0], o = t[1], i8 = t[2], s = n[0], a = n[1], l = n[2];
  return e[0] = o * l - i8 * a, e[1] = i8 * s - r * l, e[2] = r * a - o * s, e;
}
...
function wt2(e, t, n) {
  var r = n[0], o = n[1], i8 = n[2], s = n[3], a = t[0], l = t[1], p = t[2], c = o * p - i8 * l, d = i8 * a - r * p, m = r * l - o * a, g2 = o * m - i8 * d, u = i8 * c - r * m, C = r * d - o * c, x = s * 2;
  return c *= x, d *= x, m *= x, g2 *= 2, u *= 2, C *= 2, e[0] = a + c + g2, e[1] = l + d + u, e[2] = p + m + C, e;
}
...
function Rt2(e, t) {
  var n = e[0], r = e[1], o = e[2], i8 = t[0], s = t[1], a = t[2], l = Math.sqrt(n * n + r * r + o * o), p = Math.sqrt(i8 * i8 + s * s + a * a), c = l * p, d = c && ve2(e, t) / c;
  return Math.acos(Math.min(Math.max(d, -1), 1));
}
function St2(e) {
...
function Dt2(e, t) {
  var n = e[0], r = e[1], o = e[2], i8 = t[0], s = t[1], a = t[2];
  return Math.abs(n - i8) <= U * Math.max(1, Math.abs(n), Math.abs(i8)) && Math.abs(r - s) <= U * Math.max(1, Math.abs(r), Math.abs(s)) && Math.abs(o - a) <= U * Math.max(1, Math.abs(o), Math.abs(a));
}
var Ot = ce;
var At2 = le;
var It2 = pe2;
...
var Ut2 = function() {
  ...
  return function(t, n, r, o, i8, s) {
    var a, l;
    for (n || (n = 3), r || (r = 0), o ? l = Math.min(o * n + r, t.length) : l = t.length, a = r; a < l; a += n) e[0] = t[a], e[1] = t[a + 1], e[2] = t[a + 2], i8(e, e, s), t[a] = e[0], t[a + 1] = e[1], t[a + 2] = e[2];
    return t;
  };
}();
function fe2(e) {
  return (t) => import_react9.default.createElement(Y2, { overlay: e, ...t });
}
var _a40, _e_instances, e_fn4;
var Y2 = (_a40 = class extends import_react9.default.Component {
  constructor() {
    super(...arguments);
...
function pr2({ children: e, ...t }) {
  ...
  }, [i8, n]), import_react8.default.createElement(Q.Provider, { value: r }, import_react8.default.createElement("div", { ref: n, "data-role": "dom-3d-overlay", style: { position: "absolute", width: "100%", height: "100%", top: "0", pointerEvents: "none", padding: "inherit", overflow: "hidden" }, ...t }, e));
}
...
function Cr2({ entity: e, scaleFactor: t, anchor: n, children: r }) {
  let [o, i8] = (0, import_react11.useState)(e ? e.global_transform.position : [0, 0, 0]), [s, a] = (0, import_react11.useState)(e ? e.is_visible : false);
  return (0, import_react11.useEffect)(() => {
    if (!e) return;
    let l = () => i8(e.global_transform.position), p = () => a(e.is_visible);
...
typeof window < "u" && (window.__LIVELINK__ || (window.__LIVELINK__ = {}), Object.prototype.hasOwnProperty.call(window.__LIVELINK__, "@3dverse/livelink-react") ? console.warn("⚠️ WARNING ⚠️ Multiple instances of Livelink React ⚛️ being imported.") : window.__LIVELINK__["@3dverse/livelink-react"] = "0.2.48");
...
//# sourceMappingURL=chunk-GRAYCDNC.js.map
