...
var Pe = class extends Event {
  constructor({ change_source: t, is_visible: e }) {
    super("on-entity-visibility-changed");
    __publicField(this, "change_source");
    __publicField(this, "is_visible");
    this.change_source = t, this.is_visible = e;
  }
};
...
var ni = class i {
  ...
  set(t, e, n) {
    let r = Reflect.set(t, e, n);
    return this._entity._markComponentAsDirty({ component_name: this._component_name }), r;
  }
  deleteProperty(t, e) {
    let n = Reflect.deleteProperty(t, e);
    return this._entity._markComponentAsDirty({ component_name: this._component_name }), n;
  }
};
...
var qt = (_a13 = class extends ii {
  ...
  set is_visible(t) {
    __privateGet(this, _t9)._setEntityVisibility({ entity_rtid: this.rtid, is_visible: t }), __privateSet(this, _s2, t), this._dispatchEvent(new Pe({ is_visible: t, change_source: "local" }));
  }
  get parent() {
    return super.parent;
  }
  ...
  _onVisibilityChanged({ is_visible: t }) {
    __privateSet(this, _s2, t), this._dispatchEvent(new Pe({ is_visible: t, change_source: "external" }));
  }
  ...
  _setComponentValue({ ref: t, component_name: e, value: n }) {
    if (!(n === void 0 && t === void 0)) {
      if (n === void 0) {
        Reflect.deleteProperty(this, `#${e}`), this._markComponentAsDeleted({ component_name: e });
        return;
      }
      if (n === "default" && (n = __privateGet(this, _t9)._sanitizeComponentValue({ component_name: e, value: void 0 })), t === void 0) {
        let r = __privateMethod(this, _qt_instances, h_fn).call(this, { component_name: e, value: n });
        return this._markComponentAsDirty({ component_name: e }), r;
      }
...
var ai = (_a15 = class {
  ...
  async _getChildren({ entity: t }) {
    return (await __privateGet(this, _t11).getChildren({ entity_rtid: t.rtid })).map((n) => this._entity_registry.get({ entity_rtid: n.euid.rtid }) ?? new qt({ scene: this, parent: t, components: n }));
  }
...
var _t19, _i18, _e15, _n15, _a24;
var yi = (_a24 = class {
  constructor({ instance: t }) {
    __privateAdd(this, _t19);
    __privateAdd(this, _i18, []);
    __privateAdd(this, _e15, (t) => {
  ...
  enable() {
    ...
    window.addEventListener("gamepadconnected", __privateGet(this, _e15)), window.addEventListener("gamepaddisconnected", __privateGet(this, _n15));
  }
  disable() {
    window.removeEventListener("gamepadconnected", __privateGet(this, _e15)), window.removeEventListener("gamepaddisconnected", __privateGet(this, _n15));
    for (let t of __privateGet(this, _i18)) t && t.disable();
    __privateSet(this, _i18, []);
  }
  createVirtualGamepad() {
    return new ue({ instance: __privateGet(this, _t19), index: 0 });
  }
}, _t19 = new WeakMap(), _i18 = new WeakMap(), _e15 = new WeakMap(), _n15 = new WeakMap(), _a24);
var _a25, _t20, _i19, _e16, _n16, _r10, _o7, _s5, _a26, _c3, _h4, _i_instances3, l_fn2, d_fn3, m_fn3, _u, _p, _y, __fn, _f, _v;
var Ct = (_a25 = class {
  constructor({ session: t }) {
    ...
    __privateAdd(this, _p, ({ packet: t }) => {
      __privateGet(this, _r10).playAudioPacket({ packet: t });
    });
  ...
  async disconnect() {
    __privateMethod(this, _i_instances3, m_fn3).call(this), __privateGet(this, _c3) && clearInterval(__privateGet(this, _c3)), __privateGet(this, _h4) && clearInterval(__privateGet(this, _h4)), __privateGet(this, _n16) !== null && __privateGet(this, _n16).release(), __privateGet(this, _e16).release(), __privateGet(this, _r10).release(), await __privateGet(this, _t20).disconnect();
  }
  addViewports({ viewports: t }) {
...
}, _t20 = new WeakMap(), _i19 = new WeakMap(), _e16 = new WeakMap(), _n16 = new WeakMap(), _r10 = new WeakMap(), _o7 = new WeakMap(), _s5 = new WeakMap(), _a26 = new WeakMap(), _c3 = new WeakMap(), _h4 = new WeakMap(), _i_instances3 = new WeakSet(), l_fn2 = async function() {
...
var _Ir_instances, t_fn3, _i20, _e17, _n17, _r11, _o8, _s6, _a27, _c4, _h5, _l2, _d, _m, _a28;
var Ir = (_a28 = class extends mt {
  constructor({ core: t, rendering_surface: e, options: n }) {
    ...
    __privateSet(this, _i20, t), __privateSet(this, _e17, e), __privateSet(this, _a27, new dt((n == null ? void 0 : n.rect) ?? { left: 0, top: 0, width: 1, height: 1 })), __privateSet(this, _c4, (n == null ? void 0 : n.render_target_index) ?? -1), __privateSet(this, _s6, (n == null ? void 0 : n.z_index) ?? 0), __privateSet(this, _r11, (n == null ? void 0 : n.dom_element) ?? null);
  }
  ...
  get dom_element() {
    if (!__privateGet(this, _r11)) throw new Error("No DOM element set on viewport");
...
}, _i20 = new WeakMap(), _e17 = new WeakMap(), _n17 = new WeakMap(), _r11 = new WeakMap(), _o8 = new WeakMap(), _s6 = new WeakMap(), _a27 = new WeakMap(), _c4 = new WeakMap(), _h5 = new WeakMap(), _l2 = new WeakMap(), _d = new WeakMap(), _m = new WeakMap(), _a28);
var kt = "srgb";
var wn = "srgb-linear";
var Zt = class i2 {
  constructor(t = 0, e = 0) {
...
var _t21, _i21, _e19, _n18, _r12, _o9, _ts_instances, s_get, a_fn6, c_fn4, _h6, l_fn3, d_fn4, _m2, _u2, _p2, _y2, __, f_fn, v_fn, _x, _E, _g, w_fn, C_fn, _a31;
var ts = (_a31 = class extends Vi {
  constructor({ camera_entity: t, viewport: e, activate: n = true, preset: r = Sn }) {
    ...
    __privateAdd(this, _r12, { orbit_point: [0, 0, 0], wheel_timer: 0 });
...
}, _t21 = new WeakMap(), _i21 = new WeakMap(), _e19 = new WeakMap(), _n18 = new WeakMap(), _r12 = new WeakMap(), _o9 = new WeakMap(), _ts_instances = new WeakSet(), s_get = function() {
  var _a42;
  ...
  h ? (__privateGet(this, _r12).orbit_point = h, this.setOrbitPoint(...h)) : this.orbit_on_cursor.cancel_target_offset && this.setOrbitPoint(...__privateGet(this, _r12).orbit_point), this.update(__privateGet(this, _e19).getDelta());
}, C_fn = async function(t) {
  __privateGet(this, _r12).rotate_speed || (__privateGet(this, _r12).rotate_speed = { azimuth: this.azimuthRotateSpeed, polar: this.polarRotateSpeed }), this.polarRotateSpeed = 0, this.azimuthRotateSpeed = 0, document.removeEventListener("pointermove", __privateGet(this, _g), true), document.addEventListener("pointermove", __privateGet(this, _g), { capture: true, once: true });
  try {
    await __privateMethod(this, _ts_instances, w_fn).call(this, t);
  } finally {
    if (document.removeEventListener("pointermove", __privateGet(this, _g), true), __privateGet(this, _r12).rotate_speed) {
      let { azimuth: e, polar: n } = __privateGet(this, _r12).rotate_speed;
      __privateGet(this, _r12).rotate_speed = void 0, this.azimuthRotateSpeed = e, this.polarRotateSpeed = n;
    }
  }
}, _a31);
function Hh(i8) {
...
var Yh = 1e5;
var _t22, _i22, _e20, _n19, _r13, _o10, _s7, _es_instances, a_fn7, c_fn5, h_fn4, l_fn4, d_fn5, m_fn4, _a32;
var es = (_a32 = class {
  constructor({ camera_entity: t, viewport: e }) {
    ...
    __privateAdd(this, _r13, J.create());
  ...
  get clip_from_world_matrix() {
    return __privateGet(this, _r13);
  }
  get world_from_clip_matrix() {
    return J.invert(J.create(), __privateGet(this, _r13));
  }
  ...
  projectWorldToClip({ world_position: t, out_clip_position: e = L.create() }) {
    return L.transformMat4(e, t, __privateGet(this, _r13)), e;
  }
  ...
  updateFromFrameCameraTransform({ frame_camera_transform: t }) {
    ...
    let e = __privateGet(this, _r13), n = J.invert(e, t.world_from_view_matrix);
    n || (console.warn("Failed to invert world_from_view_matrix from frame_camera_transform, using identity matrix instead", t), n = J.identity(e)), __privateSet(this, _r13, J.multiply(__privateGet(this, _r13), __privateGet(this, _e20), n));
  }
}, _t22 = new WeakMap(), _i22 = new WeakMap(), _e20 = new WeakMap(), _n19 = new WeakMap(), _r13 = new WeakMap(), _o10 = new WeakMap(), _s7 = new WeakMap(), _es_instances = new WeakSet(), a_fn7 = function({ camera_entity: t }) {
...
var _i_static, _a35, t_get, i_fn2, _e22, _n21, _r14, _o11, _s8, _a36;
var as = (_a35 = class extends we {
  constructor({ decoded_frame_consumer: t }) {
    super({ decoded_frame_consumer: t });
    __privateAdd(this, _e22, null);
    __privateAdd(this, _n21, null);
    __privateAdd(this, _r14, true);
  ...
  resize({ frame_dimensions: t }) {
    __privateGet(this, _e22) && __privateGet(this, _n21) && (__privateGet(this, _n21).codedWidth = t[0], __privateGet(this, _n21).codedHeight = t[1], __privateSet(this, _r14, false), __privateGet(this, _e22).configure(__privateGet(this, _n21)));
  }
  release() {
    var _a42, _b;
  ...
  consumeEncodedFrame({ encoded_frame: t }) {
    let e = new EncodedVideoChunk({ timestamp: t.meta_data.frame_counter, type: __privateGet(this, _r14) ? "key" : "delta", data: new Uint8Array(t.video_stream.buffer, t.video_stream.byteOffset, t.video_stream.byteLength) });
    __privateSet(this, _r14, false), __privateGet(this, _o11).set(t.meta_data.frame_counter, t.meta_data), __privateGet(this, _e22).decode(e);
  }
  ...
  return null;
}, _e22 = new WeakMap(), _n21 = new WeakMap(), _r14 = new WeakMap(), _o11 = new WeakMap(), _s8 = new WeakMap(), _a36 = new WeakMap(), __privateAdd(_a35, _i_static), _a35);
var Ce = class {
  refreshSize() {
  }
};
...
var _t27, _i24, _e23, _n22, _r15, _o12, _s9, _Wi_instances, a_fn8, _a39;
var Wi = (_a39 = class {
  constructor({ canvas: t, onResized: e }) {
    ...
    __privateAdd(this, _s9, () => {
      ...
      __privateGet(this, _t27).width === 0 || __privateGet(this, _t27).height === 0 || __privateMethod(this, _Wi_instances, a_fn8).call(this, t, e) && __privateGet(this, _r15).call(this, { old_size: t, new_size: e });
    });
    __privateSet(this, _t27, t), __privateSet(this, _i24, new ResizeObserver(__privateGet(this, _o12))), __privateSet(this, _r15, e), __privateGet(this, _i24).observe(__privateGet(this, _t27));
  }
  release() {
    __privateGet(this, _i24).disconnect();
  }
}, _t27 = new WeakMap(), _i24 = new WeakMap(), _e23 = new WeakMap(), _n22 = new WeakMap(), _r15 = new WeakMap(), _o12 = new WeakMap(), _s9 = new WeakMap(), _Wi_instances = new WeakSet(), a_fn8 = function(t, e) {
...
typeof window < "u" && (window.__LIVELINK__ || (window.__LIVELINK__ = {}), Object.prototype.hasOwnProperty.call(window.__LIVELINK__, "@3dverse/livelink") ? console.warn("⚠️ WARNING ⚠️ Multiple instances of Livelink being imported.") : window.__LIVELINK__["@3dverse/livelink"] = "0.8.46");
...
//# sourceMappingURL=chunk-7GZXDDM2.js.map
